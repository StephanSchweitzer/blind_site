            ...
            <div className="relative">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12 space-y-12 bg-gray-800">
                    <section className="text-center">
                        <h1 className="text-3xl font-bold mb-4 text-gray-100">Bienvenue sur le site ECA !</h1>
                        <h2 className="text-2xl font-semibold mb-2 text-gray-200">ECA: Enregistrements à la Carte pour les Aveugles</h2>
                    </section>

                    <section className="space-y-6">
                        <p className="text-lg text-gray-300">
                            ECA/Délégation des Auxiliaires des Aveugles ("ECA") propose à ses adhérents un service personnalisé d'enregistrement sur CD MP3 des livres et documents de leur choix. ECA met aussi à leur disposition les quelque 6 000 titres du catalogue <a href="/catalogue" className="text-blue-400 font-semibold italic hover:text-blue-300">Lu Pour Vous !</a>, une sélection des meilleurs ouvrages enregistrés ces dernières années qui ne cesse de s'enrichir. ECA met en contact des lecteurs bénévoles formés par l'association et des auditeurs déficients visuels qui accèdent ainsi au plaisir de l'écoute des textes qu'ils ont choisis. Passerelle chaleureuse entre voyants et malvoyants, ECA cherche à se faire mieux connaître et à augmenter le nombre de ses adhérents.
                        </p>
                    </section>

                    <section className="space-y-4">
                        <h3 className="text-xl font-semibold text-blue-400">Un service à la carte</h3>
                        <p className="text-gray-300">Les lecteurs bénévoles d'ECA lisent VOS livres ! Les adhérents peuvent faire parvenir à ECA tous livres ou documents dont ils souhaitent l'enregistrement vocal pour leurs besoins professionnels ou de formation, ou pour leur divertissement.</p>
                    </section>

                    <section className="space-y-4">
                        <p className="text-gray-300">Grâce à sa vaste unité de stockage, ECA garde en mémoire les meilleurs enregistrements réalisés par ses lecteurs bénévoles. Inscrits au catalogue <a href="/catalogue" className="text-blue-400 font-semibold italic hover:text-blue-300">Lu Pour Vous !</a> consultable sur ce site, les livres lus sont ainsi mis à la disposition des adhérents. Mais ECA n'est pas, et ne fonctionne pas, comme une bibliothèque sonore de prêts. L'adhérent, qui choisit un titre dans <a href="/catalogue" className="text-blue-400 font-semibold italic hover:text-blue-300">Lu pour Vous !</a>, reçoit un CD-MP3 gravé à son intention qui lui reste acquis.</p>
                    </section>

                    <section className="space-y-4">
                        <h3 className="text-xl font-semibold text-blue-400">Une cotisation modique</h3>
                    ...
                    <section className="space-y-4">
                        <h3 className="text-xl font-semibold text-blue-400">Auditeurs, Bénévoles et Bienfaiteurs</h3>
