                ...
                {!contact ? (
                    ...
                    <section className="glass-card p-8 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 items-stretch">
                            ...
                            <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
                                <div className="p-2 rounded-lg bg-blue-100 dark:bg-blue-900/30">
                                    <Phone aria-hidden="true" className="h-5 w-5 text-blue-700 dark:text-blue-300" />
                                </div>
                                <div>
                            ...
                            <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
                                ...
                                <div>
                                    ...
                                    <a
                                        ...
                                        className="text-blue-800 dark:text-blue-300 hover:text-encre dark:hover:text-white underline underline-offset-2"
                                    >
                                        {contact.email}
                                    </a>
                                </div>
                            ...
                            {contact.busText && (
                                <div className="flex items-start gap-3 p-4 bg-muted rounded-lg">
                                    <div className="p-2 rounded-lg bg-blue-100 dark:bg-blue-900/30">
                                        <Bus aria-hidden="true" className="h-5 w-5 text-blue-700 dark:text-blue-300" />
                                    </div>
                                    <div>
