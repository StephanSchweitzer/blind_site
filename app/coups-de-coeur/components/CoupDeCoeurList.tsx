...
export const CoupDeCoeurList: React.FC<CoupDeCoeurListProps> = ({
    ...
    return (
        <div
            className={`bg-gray-700 rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 ease-in-out
                ${isTransitioning ? 'opacity-0 scale-95' : 'opacity-100 scale-100'}
                hover:shadow-xl hover:scale-[1.02]`}
        >
            <div className="p-6">
                <h2 className="text-2xl font-bold mb-4 text-gray-100 transition-colors duration-300 hover:text-blue-400">
                    {content[0].title}
                </h2>
                ...
                <p className="mb-6 text-gray-300 leading-relaxed transition-colors duration-300 hover:text-gray-100">
