...
const HISTORY = [
    ...
    { year: 2012, iconKey: "Archive", title: "Stockage informatique", description: "Les ECA gardent en mémoire les ouvrages enregistrés, grâce à une importante unité de stockage informatique." },
    ...
    { year: 2018, iconKey: "Users", title: "Délégation des Auxiliaires des Aveugles", description: "Aux termes du décret du 5 septembre 2018 paru au J.O. du 7 septembre 2018, les ECA deviennent une délégation des Auxiliaires des Aveugles, association loi de 1901 reconnue d'utilité publique, et prennent le nom de « ECA / Délégation des Auxiliaires des Aveugles »." },
...
const MEMBERSHIP_OPTIONS = [
    { iconKey: "Headphones", colorTheme: "blue", title: "Auditeur", sortOrder: 0, active: true, highlightLabel: "Cotisation annuelle", highlightValue: "50 €", bullets: "Non déductible des impôts, au titre de l'accession à un service\nPermet de voter à l'assemblée générale des Auxiliaires des Aveugles", ctaLabel: null, ctaHref: null, body: "Vous êtes aveugle ou malvoyant. Après paiement de votre cotisation annuelle, vous devenez auditeur membre des ECA et avez également accès à tous les services et activités de l'association Auxiliaires des Aveugles.\n\nEn ce qui concerne les enregistrements, vous pouvez faire parvenir aux ECA les livres, revues ou documents qui vous intéressent. Ce sont VOS livres que lisent les lecteurs." },
